                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <input type="text" id="name_ar" name="name_ar" class="form-control" placeholder="{{ trans('subject.placeholder.name_ar') }}">
                        </div>
                        <div class="col-12 mb-3">
                            <label for="name_en" class="form-label">{{ trans('subject.label.name_en') }}</label>
                            <input type="text" id="name_en" name="name_en" class="form-control" placeholder="{{ trans('subject.placeholder.name_en') }}">
                        </div>
                        <div class="col-12 mb-3">
                            <label for="name_fr" class="form-label">{{ trans('subject.label.name_fr') }}</label>
                            <input type="text" id="name_fr" name="name_fr" class="form-control" placeholder="{{ trans('subject.placeholder.name_fr') }}">
                        </div>
                    </div>
                </div>
