  ...
  enctype="multipart/form-data" id="version_form">
    <div class="row">
      ...
      <div class="mb-3" style="text-align: center">
        <button type="submit" id="submit_version" name="submit_version" class="btn btn-primary">{{__('Send')}}</button>
      </div>
    </div>
   ...
   <h4 class="fw-bold py-3 mb-3">
    ...
    <form class="form-horizontal" onsubmit="event.preventDefault()" action="#"
    enctype="multipart/form-data" id="misc_form">
      <div class="row">
        <div class="col-xl">
          <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="card-body">
              <div class="row  justify-content-between">
                ...
                <div class="form-group col-md-4 p-3">
                  <input type="number" class="form-control" id="duration_hours" value="{{$duration_hours}}">
                  <label class="form-label" for="duration_hours">{{__('Hours')}}</label>
                </div>

                <div class="form-group col-md-4 p-3">
                  <input type="number" class="form-control" id="duration_minutes"  value="{{$duration_minutes}}">
                  <label class="form-label" for="name">{{__('Minutes')}}</label>
                </div>

                <div class="form-group col-md-4 p-3">
                  <input type="number" class="form-control" id="duration_seconds" value="{{$duration_seconds}}">
              ...
              <div class="mb-3">
                ...
                <input type="number" class="form-control" id="posts_number" name="posts_number" value="{{$posts_number}}"/>
              </div>
            ...
            <div class="card-body">
              ...
              <div class="row  justify-content-between">
                ...
                <div class="form-group col-md-6 p-3">
                  ...
                  <div class="input-group input-group-merge">
                    <input type="number" class="form-control" id="cloud_bonus" name="cloud_bonus" value="{{$cloud_bonus}}">
                ...
                <div class="form-group col-md-6 p-3">
                  ...
                  <div class="input-group input-group-merge">
                    <input type="number" class="form-control" id="community_bonus" name="community_bonus" value="{{$community_bonus}}">
                    <span class="input-group-text">%</span>
                  </div>
                </div>
              </div>
              ...
              <div class="row  justify-content-between"  style="margin-top:10px">
                ...
                <div class="form-group col-md-4 p-3">
                  ...
                  <div class="input-group input-group-merge">
                    <input type="number" class="form-control" id="standard_bonus" name="standard_bonus" value="{{$standard_bonus}}">
                    <span class="input-group-text">%</span>
                  </div>
                </div>
                ...
                <div class="form-group col-md-4 p-3">
                  ...
                  <div class="input-group input-group-merge">
                    <input type="number" class="form-control" id="invitation_bonus" name="invitation_bonus" value="{{$invitation_bonus}}">
                    <span class="input-group-text">%</span>
                  </div>
                </div>

                <div class="form-group col-md-4 p-3">
                  <label class="form-label" for="invitation_discount">{{__('Invitation discount')}}</label>
                  <div class="input-group input-group-merge">
                    <input type="number" class="form-control" id="invitation_discount" name="invitation_discount" value="{{$invitation_discount}}">
                    <span class="input-group-text">%</span>
                  </div>
                </div>
              </div>
        ...
        <div class="mb-3" style="text-align: center">
          <button type="submit" id="submit_misc" name="submit_misc" class="btn btn-primary">{{__('Send')}}</button>
        </div>
      </div>
    ...
    <h4 class="fw-bold py-3 mb-3">
      ...
      enctype="multipart/form-data" id="contact_form">
        <div class="row">
          ...
          <div class="mb-3" style="text-align: center">
            <button type="submit" id="submit_contact" name="submit_contact" class="btn btn-primary">{{__('Send')}}</button>
          </div>
        </div>
      ...
      <h4 class="fw-bold py-3 mb-3">
        ...
        <form class="form-horizontal" onsubmit="event.preventDefault()" action="#"
        enctype="multipart/form-data" id="bank_form">
          <div class="row">
            <div class="col-xl">
              <div class="card mb-4">
                <div class="card-body">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="ccp" name="ccp" value="{{$ccp}}"/>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card mb-4">
                <div class="card-body">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="baridi_mob" name="baridi_mob" value="{{$baridi_mob}}"/>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="mb-3" style="text-align: center">
              <button type="submit" id="submit_bank" name="submit_bank" class="btn btn-primary">{{__('Send')}}</button>
            </div>
          </div>
