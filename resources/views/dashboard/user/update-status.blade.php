<div class="modal fade" id="UpdateStatusModal{{ $user->id }}" tabindex="-1" aria-hidden="true">
        ...
        <form action="{{ route('dashboard.users.changeStatus', 'test') }}" method="POST">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        {{ $user->status == 'ACTIVE' ? trans('user.inactive_confirmation') : trans('user.active_confirmation') }}
                    </p>
                </div>
