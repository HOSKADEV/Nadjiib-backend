<div class="modal fade" id="transactionModal{{ $tr->id }}" tabindex="-1" aria-hidden="true">
                      ...
                      <div class="card mb-4 h-100">
                          <div class="card-body d-flex flex-column justify-content-center">
                              <div class="mb-3">
                                  ...
                                  <input type="text" class="form-control" value="{{ $tr->amount }}"
                                      disabled />
                              </div>
                              ...
                              <div class="mb-3">
                                  ...
                                  <input type="text" class="form-control" value="{{ trans('purchase.'.$tr->payment_method) }}"
                                      disabled />
                              </div>
