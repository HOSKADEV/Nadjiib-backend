<div class="modal fade" id="acceptPurchaseModal{{ $tr->id }}" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog" role="document">
      <form action="{{ route('dashboard.wallet.update', 'test') }}" method="POST">
          ...
          <input type="hidden" id="status" name="status" class="form-control" value="{{App\Enums\WalletTransactionStatus::SUCCESS}}">
