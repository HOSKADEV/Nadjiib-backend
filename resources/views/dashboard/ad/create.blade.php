<div class="modal fade" id="createAdModal" aria-hidden="true">
            ...
            <form class="form-horizontal" hx-post="{{ route('dashboard.ads.store') }}" hx-encoding='multipart/form-data'>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="{{ trans('ad.urltype') }}" disabled />
                        <input type="text" class="form-control" id="type" name="type" value="url" hidden />
                    </div>
