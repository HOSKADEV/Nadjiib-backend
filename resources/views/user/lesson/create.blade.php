                ...
                <div class="bs-stepper wizard-vertical vertical mt-2">
                    ...
                    <div class="bs-stepper-content">
                        ...
                        <div id="upload-video" class="content">
                            ...
                            <div class="row g-6">
                                <div class="col-12 mb-2">
                                    <form class="dropzone" id="video-form" action="{{ route('user.lesson.video') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                        ...
                        <div id="upload-files" class="content">
                            ...
                            <div class="row g-6">
                                <div class="col-12 mb-2">
                                    <form class="dropzone" id="files-form" action="{{ route('user.lesson.files') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="dz-message needsclick col-12">
                                ...
                                <div class="col-12 d-flex justify-content-between">
                                    ...
                                    <a class="btn btn-success" href="{{route('user.course.lessons' , $course->id)}}">{{ __('lesson.finish') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
