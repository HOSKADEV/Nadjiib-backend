      ...
      <div class="card-body d-flex flex-column flex-md-row justify-content-between p-0 pt-6">
          ...
          <div
              ...
              <span class="card-title mb-4 px-md-12 h4">
                  <span class="text-primary text-nowrap">{{ trans('dashboard.admin_welcome') }}</span>
              </span>
              <p class="mb-4">
                {{ trans('dashboard.dashboard_explanation') }}
              </p>
      ...
      <div class="card-body d-flex justify-content-between flex-wrap-reverse">
        <div class="mb-0 w-100 app-academy-sm-60 d-flex flex-column justify-content-between text-center text-sm-start">
          <div class="card-title">
            <h5 class="text-primary mb-2">{{ trans('dashboard.purchases_section_title') }}</h5>
            <p class="text-body w-sm-80 app-academy-xl-100">
              {{ trans('dashboard.purchases_management') }}
            </p>
          </div>
          <div class="mb-0"><a href="{{route('dashboard.purchases.index')}}" class="btn btn-sm btn-primary">{{ trans('dashboard.purchases_button') }}</a></div>
        </div>
  ...
  <div class="col-lg-6">
    <div class="card shadow-none bg-label-danger h-100">
      <div class="card-body d-flex justify-content-between flex-wrap-reverse">
        <div class="mb-0 w-100 app-academy-sm-60 d-flex flex-column justify-content-between text-center text-sm-start">
          <div class="card-title">
            <h5 class="text-danger mb-2">{{ trans('dashboard.courses_section_title') }}</h5>
            <p class="text-body app-academy-sm-60 app-academy-xl-100">
              {{ trans('dashboard.courses_management') }}
            </p>
          </div>
          <div class="mb-0"><a href="{{route('dashboard.courses.index')}}" class="btn btn-sm btn-danger">{{ trans('dashboard.courses_button') }}</a></div>
        </div>
        <div class="w-100 app-academy-sm-40 d-flex justify-content-center justify-content-sm-end h-px-150 mb-4 mb-sm-0">
