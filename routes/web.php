...
Route::get('/chargily/success', 'App\Http\Controllers\API\Wallet\WalletController@chargily')->name('chargily-success-wallet');
Route::get('/chargily/failed', 'App\Http\Controllers\API\Wallet\WalletController@chargily')->name('chargily-failed-wallet');
